(function (global) {
  ...
  function issueSuggestion(issue) {
    ...
    const suggestions = {
      ...
      TEACHER_DATE_LIMIT: "請把課程移到該教師可授課日期，或到「教師設定」調整該教師的不可排課日期。",
      TEACHER_PERIOD_LIMIT: "請把課程移到該教師可排課節次，或到「教師設定」調整該教師的排課節次。",
      ...
      UNPLACED_AUTO_TASK: "請依原因調整教師設定、可授課週次、可授課星期、不可排課日期、排課節次、授課班級，或手動補排到建議時段。",
    };
